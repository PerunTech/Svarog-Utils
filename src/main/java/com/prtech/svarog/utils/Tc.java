...
public class Tc {
	...
	public static final String SVAROG_FIELDS = "SVAROG_FIELDS";
	...
	// v3
	public static final String OTSC_MODULE_MENU_ROOT_KEY = "perun.otsc.module_menu.navigation";
	public static final String OTSC_MODULE_MENU_ITEMS_KEY = "module_menu";
	...
	public static final String ACL_CONFIG_UNQ = "ACL_CONFIG_UNQ";
	public static final String SVAROG_SID_ACL = "SVAROG_SID_ACL";
	public static final String SVAROG_ACL = "SVAROG_ACL";
